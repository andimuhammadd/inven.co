...
<body>
    ...
    <div class="container-fluid" style="background-image: url('https://wallpapercave.com/wp/wp5162474.jpg'); background-size: cover; background-position: center; height: 100vh;">
        <div class="row justify-content-center align-items-center" style="height: 100vh;">
            <div class="col text-center">
                <h1 class="text-white">Selamat Datang di Website Manajemen INVENTARIS</h1>
                <p class="text-white">Selamat mengoptimalkan Inventaris Anda dan Meraih Keberhasilan yang gemilang</p>
